...
# 试衣函数
def tryon_nomask(unet, vae, dataloader, noise_scheduler, accelerator, args):
    ...
    with torch.no_grad():
        for batch in tqdm(dataloader, desc="Virtual Try-On (No-Mask)"):
...
def parse_args():
    ...
    parser.add_argument("--base_model_path", type=str,
                        default="/data0/yanglu/ckpts/sd/booksforcharliestable-diffusion-inpainting/")
    parser.add_argument('--model_path', type=str, required=True, help="Path to trained U-Net model")
    parser.add_argument('--data_root_path', type=str, default='/data0/yanglu/data/hansca-v2/T-shirt')
    ...
    parser.add_argument("--output_dir", type=str, default="tryon_output_nomask")
    parser.add_argument("--vae_path", type=str, default="/data0/yanglu/ckpts/sd/sd-vae-ft-mse")
...
def main():
    ...
    tryon_nomask(unet, vae, dataloader, noise_scheduler, accelerator, args)
